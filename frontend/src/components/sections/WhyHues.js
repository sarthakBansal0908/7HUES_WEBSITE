...
export default function WhyHues({ data }) {
  ...
  return (
    <section data-testid="section-why" className="py-24 md:py-32">
      <div className="mx-auto max-w-[1400px] px-6 md:px-10 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="order-1 lg:order-2">
          <Reveal>
            ...
            <h2 className="headline text-5xl md:text-6xl lg:text-7xl text-ink mb-10">{data.title}</h2>
          </Reveal>
